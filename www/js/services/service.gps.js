...
.provider('$gps', function () {
    ...
    this.$get = function ($q, $log, $timeout, $cordovaGeolocation) {
        ...
        var simulator = {
             ...
             * @return {simulator}
             */
            setFakeRoutes: function(routes) {
                this.fakeRoutes = routes;

                for (var i in routes) {
                    if (routes[i].hasOwnProperty('default')) {
                        this.fakeID = i;
                    }
                }
...
.config(['$gpsProvider', function ($gpsProvider) {
        
    console.log('$gpsProvider', $gpsProvider)
        
    $gpsProvider.$get().simulator.setFakeRoutes([
        {
            default: true,
            name: 'Fake route #1',
            speed: 60,
