...
function GScript(src) {console.log('aaaaa');document.write('<' + 'script src="' + src + '"' +' type="text/javascript"><' + '/script>');}
...
window.onload = function () {
	...
	//if (GBrowserIsCompatible()) {
        ...
        sizeMap();
        document.addDomListener(document.getElementById('map'), "DOMMouseScroll", wheelZoom);
        document.addDomListener(document.getElementById('map'), "mousewheel", wheelZoom);
    //} else {
